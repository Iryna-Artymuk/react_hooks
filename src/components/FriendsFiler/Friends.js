...
export default function Friends() {
  ...
  // використовується для того щоб коли в функції декілька стейтів
  // фільтрацію робтти тільки після оновлення відповідного стейту(інпуту) , а не всіх
  // useMemo повертає значеня в змінну  visibleFriends useEfect нічого не повертає тіьки виконує операцію
